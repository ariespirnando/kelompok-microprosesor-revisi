...
var
kapGb,kapdigMb,hasil,sisaGb,sisaMb:integer;
begin
//proses pemanggilan karakter dalam text box
kapGb:=strtoint(edit1.Text);
kapdigMb:=strtoint(edit2.Text);
//proses pelakukan konversi
kapGB:=kapGb*1024;
//proses penghitungan sisa kapasitas
hasil:=kapGB-kapdigMB;
sisaGb:=hasil div 1024;
sisaMb:=hasil mod 1024;
...
//formatfloat untuk membuat memunculkan 2 angka dibelakang koma
//sehingga hasil berkoma tidak terlalu panjang
